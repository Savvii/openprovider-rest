...
namespace Savvii\OpenproviderRest;
...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'Savvii/OpenproviderRest/{packageVersion}';
    ...
    {
        $report  = 'PHP SDK (Savvii\OpenproviderRest) Debug Report:' . PHP_EOL;

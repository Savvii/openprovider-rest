...
/**
     ...
     * @return \Savvii\OpenproviderRest\Model\ResellerGetResellerResponse|\Savvii\OpenproviderRest\Model\ErrorError
     */
     ...
     * @throws \Savvii\OpenproviderRest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Savvii\OpenproviderRest\Model\ResellerGetResellerResponse|\Savvii\OpenproviderRest\Model\ErrorError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getResellerWithHttpInfo($with_additional_data = null, $with_statistics = null, $with_settings = null, $with_contacts = null, string $contentType = self::contentTypes['getReseller'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Savvii\OpenproviderRest\Model\ResellerGetResellerResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Savvii\OpenproviderRest\Model\ResellerGetResellerResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Savvii\OpenproviderRest\Model\ResellerGetResellerResponse', []),
            ...
            $returnType = '\Savvii\OpenproviderRest\Model\ResellerGetResellerResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Savvii\OpenproviderRest\Model\ResellerGetResellerResponse',
     ...
     * @param  \Savvii\OpenproviderRest\Model\ResellerUpdateResellerRequest $body body (required)
     ...
     * @throws \Savvii\OpenproviderRest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Savvii\OpenproviderRest\Model\ResellerUpdateResellerResponse|\Savvii\OpenproviderRest\Model\ErrorError
     */
     ...
     *
     * @param  int $id Object ID (required)
     * @param  \Savvii\OpenproviderRest\Model\ResellerUpdateResellerRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateReseller'] to see the possible values for this operation
     *
     * @throws \Savvii\OpenproviderRest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Savvii\OpenproviderRest\Model\ResellerUpdateResellerResponse|\Savvii\OpenproviderRest\Model\ErrorError, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateResellerWithHttpInfo($id, $body, string $contentType = self::contentTypes['updateReseller'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Savvii\OpenproviderRest\Model\ResellerUpdateResellerResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Savvii\OpenproviderRest\Model\ResellerUpdateResellerResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Savvii\OpenproviderRest\Model\ResellerUpdateResellerResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\Savvii\OpenproviderRest\Model\ResellerUpdateResellerResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Savvii\OpenproviderRest\Model\ResellerUpdateResellerResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;

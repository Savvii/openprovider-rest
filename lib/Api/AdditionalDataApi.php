...
/**
     ...
     * @return \Savvii\OpenproviderRest\Model\AdditionalDataGetAdditionalDataResponse|\Savvii\OpenproviderRest\Model\ErrorError
     */
     ...
     * @throws \Savvii\OpenproviderRest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Savvii\OpenproviderRest\Model\AdditionalDataGetAdditionalDataResponse|\Savvii\OpenproviderRest\Model\ErrorError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdditionalDataWithHttpInfo($domain_name = null, $domain_extension = null, $operation = null, string $contentType = self::contentTypes['getAdditionalData'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Savvii\OpenproviderRest\Model\AdditionalDataGetAdditionalDataResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Savvii\OpenproviderRest\Model\AdditionalDataGetAdditionalDataResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Savvii\OpenproviderRest\Model\AdditionalDataGetAdditionalDataResponse', []),
            ...
            $returnType = '\Savvii\OpenproviderRest\Model\AdditionalDataGetAdditionalDataResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Savvii\OpenproviderRest\Model\AdditionalDataGetAdditionalDataResponse',

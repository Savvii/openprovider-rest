...
/**
     ...
     *
     * @param  \Savvii\OpenproviderRest\Model\AuthLoginRequest $body body (required)
     ...
     * @return \Savvii\OpenproviderRest\Model\AuthLoginResponse|\Savvii\OpenproviderRest\Model\ErrorError
     */
     ...
     * Login with username and password
     *
     * @param  \Savvii\OpenproviderRest\Model\AuthLoginRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['login'] to see the possible values for this operation
     *
     * @throws \Savvii\OpenproviderRest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Savvii\OpenproviderRest\Model\AuthLoginResponse|\Savvii\OpenproviderRest\Model\ErrorError, HTTP status code, HTTP response headers (array of strings)
     */
    public function loginWithHttpInfo($body, string $contentType = self::contentTypes['login'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Savvii\OpenproviderRest\Model\AuthLoginResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Savvii\OpenproviderRest\Model\AuthLoginResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Savvii\OpenproviderRest\Model\AuthLoginResponse', []),
            ...
            $returnType = '\Savvii\OpenproviderRest\Model\AuthLoginResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Savvii\OpenproviderRest\Model\AuthLoginResponse',

...
/**
     ...
     * @return \Savvii\OpenproviderRest\Model\TransactionListTransactionsResponse|\Savvii\OpenproviderRest\Model\ErrorError
     */
     ...
     * @throws \Savvii\OpenproviderRest\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Savvii\OpenproviderRest\Model\TransactionListTransactionsResponse|\Savvii\OpenproviderRest\Model\ErrorError, HTTP status code, HTTP response headers (array of strings)
     */
    public function listTransactionsWithHttpInfo($limit = null, $offset = null, $order = null, $order_by = null, $start_creation_date = null, $end_creation_date = null, $filter_for_subject = null, string $contentType = self::contentTypes['listTransactions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Savvii\OpenproviderRest\Model\TransactionListTransactionsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Savvii\OpenproviderRest\Model\TransactionListTransactionsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Savvii\OpenproviderRest\Model\TransactionListTransactionsResponse', []),
            ...
            $returnType = '\Savvii\OpenproviderRest\Model\TransactionListTransactionsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Savvii\OpenproviderRest\Model\TransactionListTransactionsResponse',
